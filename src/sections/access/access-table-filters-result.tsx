...
// types
import { IAccessTableFilters, IAccessTableFilterValue } from 'src/types/access';
// components
...
type Props = StackProps & {
  ...
  onFilters: (name: string, value: IAccessTableFilterValue) => void;
  //
...
export default function AccessTableFiltersResult({
  filters,
  onFilters,
  //
  onResetFilters,
