...
// types
import { FeederFilters, FeederFilterValue } from 'src/types/feeder';
// components
...
type Props = {
  ...
  onFilters: (title: string, value: FeederFilterValue) => void;
  //
  publishOptions: {
    value: number;
    label: string;
...
export default function FeederTableToolbar({
  filters,
  onFilters,
  //
  publishOptions,
